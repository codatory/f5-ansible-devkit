...
RUN python3.12 -m venv /root/ansible-venv; source /root/ansible-venv/bin/activate; python3.12 -m pip install --upgrade pip; python3.12 -m pip install ansible-dev-tools==24.9.0; python3.12 -m pip install ansible==10.4.0; python3.12 -m pip cache purge
